...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFFF33C30);
  late Color tertiaryColor = const Color(0xFF5FB677);
  late Color alternate = const Color(0xFFBA1A1A);
  ...
  late Color primaryBtnText = Color(0xFFF33C30);
  late Color lineColor = Color(0x80000000);
